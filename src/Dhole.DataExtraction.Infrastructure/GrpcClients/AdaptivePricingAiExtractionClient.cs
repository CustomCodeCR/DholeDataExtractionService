        ...
        var payload = JsonSerializer.Serialize(
            new
            {
                ...
                rules = new[]
                {
                    ...
                    "AIR: en rutas multitramos como PVG-SEA-ATL-SJO usa PVG como POL y SJO como POE. Conserva la ruta completa, tránsito y si el servicio es Consolidado o Back to back en remarks/spaceComment.",
                    "AIR: conserva relaciones volumétricas exactamente como aparecen, por ejemplo 1 CBM = 167 KG; no las sustituyas por reglas marítimas.",
