...
public sealed record ExtractionExecutionAuditSnapshot(
    ...
    Guid? SourceOriginId,
    Guid? SourceEmailMessageId,
    Guid? SourceEmailAttachmentId,
    string Status,
    int TotalRows,
    int ValidRows,
    int WarningRows,
...
)
{
    public static ExtractionExecutionAuditSnapshot From(ExtractionExecution execution)
    {
        return new ExtractionExecutionAuditSnapshot(
            ...
            execution.SourceOriginType,
            execution.SourceOriginId,
            execution.SourceEmailMessageId,
            execution.SourceEmailAttachmentId,
